...
declare module "channel_state" {
    export class ChannelState {
        ...
        removeMessageFromArray: (msgArray: any, msg: any) => {
            removed: boolean;
            result: any;
        };
        /**
...
declare module "connection" {
    ...
    export class StableWSConnection {
        constructor({ wsBaseURL, clientID, userID, user, userAgent, apiKey, tokenManager, authType, messageCallback, recoverCallback, eventCallback, logger, }: {
            wsBaseURL: any;
            clientID: any;
            userID: any;
            user: any;
...
declare module "signing" {
     ...
     */
    export function JWTUserToken(apiSecret: string, userId: string, extraData?: object | undefined, jwtOptions?: object | undefined): string;
...
declare module "client" {
    export class StreamChat {
         ...
         */
        channel(channelType: string, channelID: string, custom?: object | undefined, ...args: any[]): Channel;
        /**
...
declare module "permissions" {
    ...
    export class Permission {
        constructor(name: any, priority: any, resources?: string[], roles?: string[], owner?: boolean, action?: string);
        name: any;
        action: string;
        owner: boolean;
        priority: any;
