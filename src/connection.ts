...
> {
   ...
   *
   * @return {Promise<ConnectionOpen<AttachmentType, ChannelType, EventType, MessageType, ReactionType, UserType> | undefined>} Promise that completes once the first health check message is received
   */
  async _connect() {
