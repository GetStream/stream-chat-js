...
// @generated from protobuf file "chat/channel_v2/channel.proto" (package "stream.chat.channel_v2", syntax proto3)
// tslint:disable
...
import { MessageView } from "../message_v2/message";
import { User } from "../user_v2/user";
import { Timestamp } from "../../google/protobuf/timestamp";
/**
 * Channel represents core channel entity
 *
 * @generated from protobuf message stream.chat.channel_v2.Channel
 */
export interface Channel {
     ...
     *
     * @generated from protobuf field: stream.chat.channel_v2.ChannelSettings settings = 6;
     */
    settings?: ChannelSettings;
    /**
     * Contains channel summary statistics that are subject of the frequent change.
     *
     * @generated from protobuf field: stream.chat.channel_v2.ChannelStats stats = 7;
     */
    stats?: ChannelStats;
    /**
     * Contains channel translation settings.
     *
     * @generated from protobuf field: stream.chat.channel_v2.ChannelTranslation translation = 8;
     */
    translation?: ChannelTranslation;
    /**
     * Contains channel truncation information. If empty - channel was never truncated
     *
     * @generated from protobuf field: stream.chat.channel_v2.ChannelTruncationStatus truncated = 9;
     */
    truncated?: ChannelTruncationStatus;
    /**
     * Contains the list of commands that the channel supports.
     *
     * @generated from protobuf field: repeated stream.chat.channel_v2.ChannelCommand commands = 10;
     */
 ...
 * Contains core channel settings.
 *
 * @generated from protobuf message stream.chat.channel_v2.ChannelSettings
 */
 ...
 * Contains channel translation settings.
 *
 * @generated from protobuf message stream.chat.channel_v2.ChannelTranslation
 */
 ...
 * Contains channel summary statistics that are subject of the frequent change.
 *
 * @generated from protobuf message stream.chat.channel_v2.ChannelStats
 */
 ...
 *
 * @generated from protobuf message stream.chat.channel_v2.ChannelTruncationStatus
 */
 ...
 *
 * @generated from protobuf message stream.chat.channel_v2.ChannelView
 */
export interface ChannelView {
    /**
     * Contains core channel information.
     *
     * @generated from protobuf field: stream.chat.channel_v2.Channel channel = 1;
     */
    channel?: Channel;
    /**
     * Creator of the channel.
     *
     * @generated from protobuf field: stream.chat.user_v2.User created_by = 2;
     */
    createdBy?: User;
    /**
     * Channel members. Only fist 100 members are provided in this field.
     *
     * @generated from protobuf field: repeated stream.chat.channel_v2.ChannelMemberView members = 3;
     */
     ...
     *
     * @generated from protobuf field: repeated stream.chat.message_v2.MessageView messages = 4;
     */
 ...
 *
 * @generated from protobuf message stream.chat.channel_v2.ChannelMember
 */
export interface ChannelMember {
     ...
     *
     * @generated from protobuf field: stream.chat.channel_v2.ChannelMemberInvitation invitation = 3;
     */
     ...
     * is not banned.
     *
     * @generated from protobuf field: stream.chat.channel_v2.ChannelMemberBan ban = 4;
     */
 ...
 *
 * @generated from protobuf message stream.chat.channel_v2.ChannelMemberView
 */
export interface ChannelMemberView {
    /**
     * ChannelMember that this view is for.
     *
     * @generated from protobuf field: stream.chat.channel_v2.ChannelMember channel_member = 1;
     */
 ...
 *
 * @generated from protobuf message stream.chat.channel_v2.ChannelMemberInvitation
 */
 ...
 *
 * @generated from protobuf message stream.chat.channel_v2.ChannelMemberBan
 */
 ...
 *
 * @generated from protobuf message stream.chat.channel_v2.ChannelIdentifier
 */
 ...
 *
 * @generated from protobuf message stream.chat.channel_v2.ChannelCommand
 */
...
class Channel$Type extends MessageType<Channel> {
    constructor() {
        super("stream.chat.channel_v2.Channel", [
    ...
    internalBinaryWrite(message: Channel, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated stream.chat.channel_v2.ChannelCommand commands = 10; */
...
/**
 * @generated MessageType for protobuf message stream.chat.channel_v2.Channel
 */
export const Channel = new Channel$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ChannelSettings$Type extends MessageType<ChannelSettings> {
    constructor() {
        super("stream.chat.channel_v2.ChannelSettings", [
...
/**
 * @generated MessageType for protobuf message stream.chat.channel_v2.ChannelSettings
 */
...
class ChannelTranslation$Type extends MessageType<ChannelTranslation> {
    constructor() {
        super("stream.chat.channel_v2.ChannelTranslation", [
...
/**
 * @generated MessageType for protobuf message stream.chat.channel_v2.ChannelTranslation
 */
export const ChannelTranslation = new ChannelTranslation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ChannelStats$Type extends MessageType<ChannelStats> {
    constructor() {
        super("stream.chat.channel_v2.ChannelStats", [
...
/**
 * @generated MessageType for protobuf message stream.chat.channel_v2.ChannelStats
 */
...
class ChannelTruncationStatus$Type extends MessageType<ChannelTruncationStatus> {
    constructor() {
        super("stream.chat.channel_v2.ChannelTruncationStatus", [
...
/**
 * @generated MessageType for protobuf message stream.chat.channel_v2.ChannelTruncationStatus
 */
...
class ChannelView$Type extends MessageType<ChannelView> {
    constructor() {
        super("stream.chat.channel_v2.ChannelView", [
    ...
    internalBinaryWrite(message: ChannelView, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* stream.chat.channel_v2.Channel channel = 1; */
        if (message.channel)
        ...
        /* repeated stream.chat.channel_v2.ChannelMemberView members = 3; */
...
/**
 * @generated MessageType for protobuf message stream.chat.channel_v2.ChannelView
 */
export const ChannelView = new ChannelView$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ChannelMember$Type extends MessageType<ChannelMember> {
    constructor() {
        super("stream.chat.channel_v2.ChannelMember", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string channel_role */ 2:
                    ...
                    break;
                case /* stream.chat.channel_v2.ChannelMemberInvitation invitation */ 3:
                    message.invitation = ChannelMemberInvitation.internalBinaryRead(reader, reader.uint32(), options, message.invitation);
                    break;
                case /* stream.chat.channel_v2.ChannelMemberBan ban */ 4:
    ...
    internalBinaryWrite(message: ChannelMember, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* stream.chat.channel_v2.ChannelMemberInvitation invitation = 3; */
        ...
        /* stream.chat.channel_v2.ChannelMemberBan ban = 4; */
        if (message.ban)
...
/**
 * @generated MessageType for protobuf message stream.chat.channel_v2.ChannelMember
 */
export const ChannelMember = new ChannelMember$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ChannelMemberView$Type extends MessageType<ChannelMemberView> {
    constructor() {
        super("stream.chat.channel_v2.ChannelMemberView", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ChannelMemberView): ChannelMemberView {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* stream.chat.channel_v2.ChannelMember channel_member */ 1:
    ...
    internalBinaryWrite(message: ChannelMemberView, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* stream.chat.channel_v2.ChannelMember channel_member = 1; */
...
/**
 * @generated MessageType for protobuf message stream.chat.channel_v2.ChannelMemberView
 */
...
class ChannelMemberInvitation$Type extends MessageType<ChannelMemberInvitation> {
    constructor() {
        super("stream.chat.channel_v2.ChannelMemberInvitation", [
...
/**
 * @generated MessageType for protobuf message stream.chat.channel_v2.ChannelMemberInvitation
 */
...
class ChannelMemberBan$Type extends MessageType<ChannelMemberBan> {
    constructor() {
        super("stream.chat.channel_v2.ChannelMemberBan", [
...
/**
 * @generated MessageType for protobuf message stream.chat.channel_v2.ChannelMemberBan
 */
...
class ChannelIdentifier$Type extends MessageType<ChannelIdentifier> {
    constructor() {
        super("stream.chat.channel_v2.ChannelIdentifier", [
...
/**
 * @generated MessageType for protobuf message stream.chat.channel_v2.ChannelIdentifier
 */
export const ChannelIdentifier = new ChannelIdentifier$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ChannelCommand$Type extends MessageType<ChannelCommand> {
    constructor() {
        super("stream.chat.channel_v2.ChannelCommand", [
...
/**
 * @generated MessageType for protobuf message stream.chat.channel_v2.ChannelCommand
 */
