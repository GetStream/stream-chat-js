...
// @generated from protobuf file "chat/client_v2_rpc/channel.proto" (package "stream.chat.client_v2_rpc", syntax proto3)
// tslint:disable
...
import { Sort } from "../utils_v2/utils";
import { Pager } from "../utils_v2/utils";
import { Timestamp } from "../../google/protobuf/timestamp";
import { ChannelIdentifier } from "../channel_v2/channel";
import { ChannelMemberView } from "../channel_v2/channel";
import { ChannelView } from "../channel_v2/channel";
/**
 * A view which User gets when they request a channel
 *
 * @generated from protobuf message stream.chat.client_v2_rpc.ChannelUserView
 */
export interface ChannelUserView {
    /**
     * Contains base channel view.
     *
     * @generated from protobuf field: stream.chat.channel_v2.ChannelView channel_view = 1;
     */
    channelView?: ChannelView;
    /**
     * Contains user settings for this channel.
     *
     * @generated from protobuf field: stream.chat.client_v2_rpc.ChannelUserSettings user_settings = 2;
     */
    userSettings?: ChannelUserSettings;
    /**
     * List of channel capabilities that are available to the user.
     *
     * @generated from protobuf field: repeated stream.chat.client_v2_rpc.ChannelCapability capabilities = 3;
     */
     ...
     * on this channel.
     *
     * @generated from protobuf field: stream.chat.channel_v2.ChannelMemberView membership = 4;
     */
 ...
 *
 * @generated from protobuf message stream.chat.client_v2_rpc.GetChannelRequest
 */
export interface GetChannelRequest {
    /**
     * Channel identifier object.
     *
     * @generated from protobuf field: stream.chat.channel_v2.ChannelIdentifier identifier = 1;
     */
 ...
 *
 * @generated from protobuf message stream.chat.client_v2_rpc.GetChannelResponse
 */
export interface GetChannelResponse {
    /**
     * Contains base channel view.
     *
     * @generated from protobuf field: stream.chat.client_v2_rpc.ChannelUserView channel = 1;
     */
 ...
 *
 * @generated from protobuf message stream.chat.client_v2_rpc.ChannelUserSettings
 */
 ...
 *
 * @generated from protobuf message stream.chat.client_v2_rpc.QueryChannelsRequest
 */
export interface QueryChannelsRequest {
     ...
     *
     * @generated from protobuf field: stream.chat.utils_v2.Pager pager = 2;
     */
    pager?: Pager;
    /**
     * Sort is used to provide sort direction. By default channels are sort by XX ASC (TODO: fill this in)
     *
     * @generated from protobuf field: repeated stream.chat.utils_v2.Sort sort = 3;
     */
    sort: Sort[];
}
/**
 * Request to get the list of channels.
 *
 * @generated from protobuf message stream.chat.client_v2_rpc.QueryChannelsResponse
 */
export interface QueryChannelsResponse {
    /**
     * List of channels.
     *
     * @generated from protobuf field: repeated stream.chat.client_v2_rpc.ChannelUserView channels = 1;
     */
 ...
 *
 * @generated from protobuf enum stream.chat.client_v2_rpc.ChannelCapability
 */
...
class ChannelUserView$Type extends MessageType<ChannelUserView> {
    constructor() {
        super("stream.chat.client_v2_rpc.ChannelUserView", [
            { no: 1, name: "channel_view", kind: "message", T: () => ChannelView },
            { no: 2, name: "user_settings", kind: "message", T: () => ChannelUserSettings },
            { no: 3, name: "capabilities", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["stream.chat.client_v2_rpc.ChannelCapability", ChannelCapability, "CHANNEL_CAPABILITY_"] },
            ...
            switch (fieldNo) {
                ...
                case /* repeated stream.chat.client_v2_rpc.ChannelCapability capabilities */ 3:
                    if (wireType === WireType.LengthDelimited)
                        ...
                        message.capabilities.push(reader.int32());
                    break;
                case /* stream.chat.channel_v2.ChannelMemberView membership */ 4:
    ...
    internalBinaryWrite(message: ChannelUserView, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* stream.chat.client_v2_rpc.ChannelUserSettings user_settings = 2; */
        ...
        /* repeated stream.chat.client_v2_rpc.ChannelCapability capabilities = 3; */
...
/**
 * @generated MessageType for protobuf message stream.chat.client_v2_rpc.ChannelUserView
 */
export const ChannelUserView = new ChannelUserView$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetChannelRequest$Type extends MessageType<GetChannelRequest> {
    constructor() {
        super("stream.chat.client_v2_rpc.GetChannelRequest", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetChannelRequest): GetChannelRequest {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* stream.chat.channel_v2.ChannelIdentifier identifier */ 1:
...
/**
 * @generated MessageType for protobuf message stream.chat.client_v2_rpc.GetChannelRequest
 */
...
class GetChannelResponse$Type extends MessageType<GetChannelResponse> {
    constructor() {
        super("stream.chat.client_v2_rpc.GetChannelResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetChannelResponse): GetChannelResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* stream.chat.client_v2_rpc.ChannelUserView channel */ 1:
    ...
    internalBinaryWrite(message: GetChannelResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* stream.chat.client_v2_rpc.ChannelUserView channel = 1; */
        if (message.channel)
...
/**
 * @generated MessageType for protobuf message stream.chat.client_v2_rpc.GetChannelResponse
 */
...
class ChannelUserSettings$Type extends MessageType<ChannelUserSettings> {
    constructor() {
        super("stream.chat.client_v2_rpc.ChannelUserSettings", [
...
/**
 * @generated MessageType for protobuf message stream.chat.client_v2_rpc.ChannelUserSettings
 */
...
class QueryChannelsRequest$Type extends MessageType<QueryChannelsRequest> {
    constructor() {
        super("stream.chat.client_v2_rpc.QueryChannelsRequest", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bytes mq */ 1:
                    ...
                    break;
                case /* stream.chat.utils_v2.Pager pager */ 2:
                    message.pager = Pager.internalBinaryRead(reader, reader.uint32(), options, message.pager);
                    break;
                case /* repeated stream.chat.utils_v2.Sort sort */ 3:
...
/**
 * @generated MessageType for protobuf message stream.chat.client_v2_rpc.QueryChannelsRequest
 */
...
class QueryChannelsResponse$Type extends MessageType<QueryChannelsResponse> {
    constructor() {
        super("stream.chat.client_v2_rpc.QueryChannelsResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QueryChannelsResponse): QueryChannelsResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated stream.chat.client_v2_rpc.ChannelUserView channels */ 1:
    ...
    internalBinaryWrite(message: QueryChannelsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated stream.chat.client_v2_rpc.ChannelUserView channels = 1; */
...
/**
 * @generated MessageType for protobuf message stream.chat.client_v2_rpc.QueryChannelsResponse
 */
