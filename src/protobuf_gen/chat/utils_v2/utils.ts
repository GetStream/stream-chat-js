...
// @generated from protobuf file "chat/utils_v2/utils.proto" (package "stream.chat.utils_v2", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message stream.chat.utils_v2.Pager
 */
...
/**
 * @generated from protobuf message stream.chat.utils_v2.Sort
 */
export interface Sort {
    ...
    field: string;
    /**
     * @generated from protobuf field: stream.chat.utils_v2.Direction direction = 2;
     */
    direction: Direction;
}
/**
 * @generated from protobuf enum stream.chat.utils_v2.Direction
 */
...
class Pager$Type extends MessageType<Pager> {
    constructor() {
        super("stream.chat.utils_v2.Pager", [
...
/**
 * @generated MessageType for protobuf message stream.chat.utils_v2.Pager
 */
export const Pager = new Pager$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Sort$Type extends MessageType<Sort> {
    constructor() {
        super("stream.chat.utils_v2.Sort", [
            { no: 1, name: "field", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "direction", kind: "enum", T: () => ["stream.chat.utils_v2.Direction", Direction, "DIRECTION_"] }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string field */ 1:
                    ...
                    break;
                case /* stream.chat.utils_v2.Direction direction */ 2:
    ...
    internalBinaryWrite(message: Sort, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* stream.chat.utils_v2.Direction direction = 2; */
...
/**
 * @generated MessageType for protobuf message stream.chat.utils_v2.Sort
 */
