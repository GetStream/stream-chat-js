...
// @generated from protobuf file "chat/reaction_v2/reaction.proto" (package "stream.chat.reaction_v2", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message stream.chat.reaction_v2.Reaction
 */
 ...
 *
 * @generated from protobuf message stream.chat.reaction_v2.ReactionView
 */
export interface ReactionView {
    /**
     * The reaction
     *
     * @generated from protobuf field: stream.chat.reaction_v2.Reaction reaction = 1;
     */
    reaction?: Reaction;
    /**
 ...
 *
 * @generated from protobuf message stream.chat.reaction_v2.ReactionViews
 */
export interface ReactionViews {
    /**
     * List of reaction views
     *
     * @generated from protobuf field: repeated stream.chat.reaction_v2.ReactionView reactions = 1;
     */
...
class Reaction$Type extends MessageType<Reaction> {
    constructor() {
        super("stream.chat.reaction_v2.Reaction", [
...
/**
 * @generated MessageType for protobuf message stream.chat.reaction_v2.Reaction
 */
export const Reaction = new Reaction$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ReactionView$Type extends MessageType<ReactionView> {
    constructor() {
        super("stream.chat.reaction_v2.ReactionView", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ReactionView): ReactionView {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* stream.chat.reaction_v2.Reaction reaction */ 1:
    ...
    internalBinaryWrite(message: ReactionView, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* stream.chat.reaction_v2.Reaction reaction = 1; */
        if (message.reaction)
...
/**
 * @generated MessageType for protobuf message stream.chat.reaction_v2.ReactionView
 */
export const ReactionView = new ReactionView$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ReactionViews$Type extends MessageType<ReactionViews> {
    constructor() {
        super("stream.chat.reaction_v2.ReactionViews", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ReactionViews): ReactionViews {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated stream.chat.reaction_v2.ReactionView reactions */ 1:
    ...
    internalBinaryWrite(message: ReactionViews, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated stream.chat.reaction_v2.ReactionView reactions = 1; */
...
/**
 * @generated MessageType for protobuf message stream.chat.reaction_v2.ReactionViews
 */
