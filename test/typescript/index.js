...
const executables = [
	{
		...
		type: "Unpacked<ReturnType<Channel<{}, { description?: string; image?: string }, string & {}, {}, {}, {}, { song?: string }>['acceptInvite']>>",
	},
	{
		f: rg.addDevice,
	...
	},
	{
		f: rg.addModerators,
		imports: ['Channel', 'Unpacked'],
		type: "Unpacked<ReturnType<Channel<{}, { description?: string }, string & {}, {}, {}, {}, {}>['addModerators']>>",
	},
	{
		f: rg.banUsers,
		imports: ['StreamChat', 'Unpacked'],
	...
	},
	{
		...
		imports: ['StreamChat', 'Unpacked'],
		type: "Unpacked<ReturnType<StreamChat<{}, { description?: string }, string & {}, {}, {}, {}, {}>['createBlockList']>>",
	},
	...
	// },
	{
		f: rg.createCommand,
		imports: ['StreamChat', 'Unpacked'],
		type: "Unpacked<ReturnType<StreamChat<{}, {}, 'testCreateCommand' | 'testCreateCommand_set' | 'testDeleteCommand' | 'testDeleteCommand_set' | 'testGetCommand' | 'testGetCommand_set' | 'testListCommand' | 'testListCommand_set' | 'testUpdateCommand' | 'testUpdateCommand_set' | 'testUpdateCommand_set_two' | 'ticket' | '', {}, {}, {}, {} >['createCommand']>>",
	},
	{
	...
	},
	{
		...
		imports: ['StreamChat', 'Unpacked'],
		type: "Unpacked<ReturnType<StreamChat<{}, { description?: string }, string & {}, {}, {}, {}, {}>['deleteBlockList']>>",
	},
	{
		f: rg.deleteChannel,
		imports: ['Channel', 'Unpacked'],
	...
	// },
	{
		f: rg.deleteCommand,
		imports: ['StreamChat', 'Unpacked'],
		type: "Unpacked<ReturnType<StreamChat<{}, {}, 'testCreateCommand' | 'testCreateCommand_set' | 'testDeleteCommand' | 'testDeleteCommand_set' | 'testGetCommand' | 'testGetCommand_set' | 'testListCommand' | 'testListCommand_set' | 'testUpdateCommand' | 'testUpdateCommand_set' | 'testUpdateCommand_set_two' | 'ticket' | '', {}, {}, {}, {}>['deleteCommand']>>",
	},
	{
		f: rg.deleteFile,
		imports: ['Channel', 'Unpacked'],
	...
	},
	{
		f: rg.deleteReaction,
		imports: ['Channel', 'Unpacked'],
		type: "Unpacked<ReturnType<Channel<{}, { description?: string }, string & {}, {}, {}, {}, {}>['deleteReaction']>>",
	},
	{
		f: rg.deleteUser,
		imports: ['StreamChat', 'Unpacked'],
	...
	},
	{
		...
		imports: ['Channel', 'Unpacked'],
		type: "Unpacked<ReturnType<Channel<{}, { description?: string }, string & {}, {}, {}, {}, {}>['demoteModerators']>>",
	},
	{
		f: rg.disconnect,
		imports: ['StreamChat', 'Unpacked'],
	...
	},
	{
		f: rg.flagMessage,
		imports: ['StreamChat', 'Unpacked'],
		type: "Unpacked<ReturnType<StreamChat<{}, {}, string & {}, {}, {}, {}, { image: string, status: string }>['flagMessage']>>",
	},
	{
		f: rg.flagUser,
		imports: ['StreamChat', 'Unpacked'],
		type: "Unpacked<ReturnType<StreamChat<{}, {}, string & {}, {}, {}, {}, { image: string, status: string }>['flagUser']>>",
	},
	{
		f: rg.getAppSettings,
		imports: ['StreamChat', 'Unpacked'],
	...
	},
	{
		f: rg.getCommand,
		imports: ['StreamChat', 'Unpacked'],
		type: "Unpacked<ReturnType<StreamChat<{}, {}, 'testCreateCommand' | 'testCreateCommand_set' | 'testDeleteCommand' | 'testDeleteCommand_set' | 'testGetCommand' | 'testGetCommand_set' | 'testListCommand' | 'testListCommand_set' | 'testUpdateCommand' | 'testUpdateCommand_set' | 'testUpdateCommand_set_two' | 'ticket' | '', {}, {}, {}, {}>['getCommand']>>",
	},
	{
		f: rg.getConfig,
		imports: ['Channel', 'Unpacked'],
	...
	},
	{
		...
		imports: ['Channel', 'Unpacked'],
		type: "Unpacked<ReturnType<Channel<{}, { description?: string }, string & {}, {}, {}, {}, {}>['getMessagesById']>>",
	},
	{
		f: rg.getMessageWithReply,
		imports: ['StreamChat', 'Unpacked'],
		type: "Unpacked<ReturnType<StreamChat<{}, {}, string & {}, {}, {}, {}, { testString?: string }>['getMessage']>>",
	},
	{
		f: rg.getPermission,
		imports: ['StreamChat', 'Unpacked'],
	...
	},
	{
		f: rg.getReactions,
		imports: ['Channel', 'Unpacked'],
		type: "Unpacked<ReturnType<Channel<{}, { description?: string }, string & {}, {}, {}, {}, {}>['getReactions']>>",
	},
	{
		f: rg.getReplies,
		imports: ['Channel', 'Unpacked'],
		type: "Unpacked<ReturnType<Channel<{ description?: string }, {}, string & {}, {}, {}, {}, { instrument?: string }>['getReplies']>>",
	},
	{
		f: rg.hide,
		imports: ['Channel', 'Unpacked'],
	...
	},
	{
		f: rg.inviteMembers,
		imports: ['Channel', 'Unpacked'],
		type: "Unpacked<ReturnType<Channel<{}, { description?: string }, string & {}, {}, {}, {}, {}>['inviteMembers']>>",
	},
	{
		f: rg.keystroke,
		imports: ['Channel', 'Unpacked'],
	...
	},
	{
		...
		type: "Omit<FormatMessageResponse<{}, { description?: string }, string & {}, {}, {}, {}>, 'created_at' | 'updated_at'> & { created_at?: string; updated_at?: string } | undefined",
	},
	{
		f: rg.listBlockLists,
		imports: ['StreamChat', 'Unpacked'],
	...
	},
	{
		f: rg.listCommands,
		imports: ['StreamChat', 'Unpacked'],
		type: "Unpacked<ReturnType<StreamChat<{}, {}, 'testCreateCommand' | 'testCreateCommand_set' | 'testDeleteCommand' | 'testDeleteCommand_set' | 'testGetCommand' | 'testGetCommand_set' | 'testListCommand' | 'testListCommand_set' | 'testUpdateCommand' | 'testUpdateCommand_set' | 'testUpdateCommand_set_two' | 'ticket' | '', {}, {}, {}, {}>['listCommands']>>",
	},
	{
	...
	},
	{
		...
		imports: ['StreamChat', 'Unpacked'],
		type: "Unpacked<ReturnType<StreamChat<{}, {}, string & {}, {}, {}, {}, { gender: string; unique: string }>['partialUpdateUser']>>",
	},
	{
		f: rg.partialUpdateUsers,
		imports: ['StreamChat', 'Unpacked'],
		type: "Unpacked<ReturnType<StreamChat<{}, {}, string & {}, {}, {}, {}, { gender: string; unique: string; work?: string }>['partialUpdateUsers']>>",
	},
	{
		f: rg.query,
		imports: ['Channel', 'Unpacked'],
	...
	// },
	{
		f: rg.queryMembers,
		imports: ['Channel', 'Unpacked'],
		type: "Unpacked<ReturnType<Channel<{}, { description?: string }, string & {}, {}, {}, {}, {}>['queryMembers']>>",
	},
	{
		f: rg.queryUsers,
		imports: ['StreamChat', 'Unpacked'],
	...
	},
	{
		f: rg.rejectInvite,
		imports: ['Channel', 'Unpacked'],
		type: "Unpacked<ReturnType<Channel<{}, { description?: string; image?: string }, string & {}, {}, {}, {}, { song?: string }>['rejectInvite']>>",
	},
	{
		f: rg.removeMembers,
		imports: ['Channel', 'Unpacked'],
		type: "Unpacked<ReturnType<Channel<{}, { description?: string }, string & {}, {}, {}, {}, {}>['removeMembers']>>",
	},
	{
	...
	},
	{
		f: rg.sendAction,
		imports: ['Channel', 'Unpacked'],
		type: "Unpacked<ReturnType<Channel<{}, { description?: string }, string & {}, {}, {}, {}, { testString?: string }>['sendAction']>>",
	},
	{
		f: rg.sendFile,
		imports: ['Channel', 'Unpacked'],
	...
	},
	{
		f: rg.sendMessage,
		imports: ['Channel', 'Unpacked'],
		type: "Unpacked<ReturnType<Channel<{}, { description?: string }, string & {}, {}, {}, {}, { testString?: string }>['sendMessage']>>",
	},
	{
	...
	},
	{
		f: rg.sendReaction,
		imports: ['Channel', 'Unpacked'],
		type: "Unpacked<ReturnType<Channel<{}, { description?: string }, string & {}, {}, {}, {}, {}>['sendReaction']>>",
	},
	{
		f: rg.setGuestUser,
		imports: ['StreamChat', 'Unpacked'],
	...
	},
	{
		f: rg.stopWatching,
		imports: ['Channel', 'Unpacked'],
		type: "Unpacked<ReturnType<Channel<{}, { description?: string }, string & {}, {}, {}, {}, {}>['stopWatching']>>",
	},
	{
		f: rg.sync,
		imports: ['StreamChat', 'Unpacked'],
	...
	},
	{
		f: rg.unflagMessage,
		imports: ['StreamChat', 'Unpacked'],
		type: "Unpacked<ReturnType<StreamChat<{}, {}, string & {}, {}, {}, {}, { image: string, status: string }>['unflagMessage']>>",
	},
	{
		f: rg.unflagUser,
		imports: ['StreamChat', 'Unpacked'],
		type: "Unpacked<ReturnType<StreamChat<{}, {}, string & {}, {}, {}, {}, { image: string, status: string }>['unflagUser']>>",
	},
	{
		f: rg.unmute,
		imports: ['Channel', 'Unpacked'],
	...
	},
	{
		...
		imports: ['StreamChat', 'Unpacked'],
		type: "Unpacked<ReturnType<StreamChat<{}, { description: string }, string & {}, {}, {}, {}, {}>['updateBlockList']>>",
	},
	{
		f: rg.updateChannel,
		imports: ['Channel', 'Unpacked'],
	...
	},
	{
		...
		imports: ['Channel', 'Unpacked'],
		type: "Unpacked<ReturnType<Channel<{}, { description: string; smallTitle: string }, string & {}, {}, {}, {}, {}>['update']>>",
	},
	{
	...
	},
	{
		f: rg.updateCommand,
		imports: ['StreamChat', 'Unpacked'],
		type: "Unpacked<ReturnType<StreamChat<{}, {}, 'testCreateCommand' | 'testCreateCommand_set' | 'testDeleteCommand' | 'testDeleteCommand_set' | 'testGetCommand' | 'testGetCommand_set' | 'testListCommand' | 'testListCommand_set' | 'testUpdateCommand' | 'testUpdateCommand_set' | 'testUpdateCommand_set_two' | 'ticket' | '', {}, {}, {}, {}>['updateCommand']>>",
	},
	{
		f: rg.updateMessage,
		imports: ['StreamChat', 'Unpacked'],
		type: "Unpacked<ReturnType<StreamChat<{}, {}, string & {}, {}, {}, {}, { testString?: string }>['updateMessage']>>",
	},
	{
